            ...
            <View className="flex-1">
                ...
                <View className="px-4 py-3">
                    <View className="flex-row items-center">
                        ...
                        <Text className="text-lg font-bold text-black ml-4">Looking for a commentator to hire</Text>
                    </View>
                </View>
                ...
                >
                    {/* Need a scorer for */}
                    <View className="mb-6">
                        <Text className="text-base font-medium text-gray-800 mb-3">Need an commentator for?</Text>
                    ...
                    <TouchableOpacity className="mb-6" onPress={() => setShowEndDatePicker(true)}>
                        <View className="flex-row items-center justify-between">
                            <Text className="text-base font-medium text-gray-600">{hireDate ? hireDate : `When do you need commentator?`}</Text>
                    ...
                    <View className="mb-6">
                        <Text className="text-base font-medium text-gray-800 mb-3">How can commentator contact you?</Text>
                        <View className="flex-row flex-wrap">
                    ...
                    <View className="mb-8">
                        <TextInput
                            ...
                            placeholder="Write details like for how many days or matches do You need commentator for?"
                            multiline
