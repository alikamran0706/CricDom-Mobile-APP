...
import SettingsSidebar from "@/components/scoring/MatchSettingsSidebar"
...
export default function ScorerScreen() {
    ...
    const [snapPoints, setSnapPoints] = useState(["30%", "55%"]);
    ...
    const runRate = matchState.totalRuns / (matchState.overs + matchState.balls / 6)
    const requiredRate = matchState.target
        ? (matchState.target - matchState.totalRuns) / (20 - (matchState.overs + matchState.balls / 6))
        : 0
    ...
    return (
        <GestureHandlerRootView style={{ flex: 1 }}>
            <View className="flex-1 bg-gray-50">
                ...
                <View>
                    {/* <View className="bg-gray-200 flex-row items-center justify-center py-1">
                            <Text>Scoring Shortcuts</Text>
                    </View> */}
                    <ScoringShortcutsHeader openBottomSheet={openBottomSheet} setSnapPoints={setSnapPoints} />
            ...
            <SettingsSidebar isVisible={showSettings} onClose={() => setShowSettings(false)} />
...
export function ScoringShortcutsHeader({ openBottomSheet, setSnapPoints }: ScoringShortcutsHeaderProps) {
    ...
    return (
        ...
        >
            <View className="flex-row items-center justify-center bg-gray-200 py-1">
                <Text className="mr-2 font-medium text-base">Scoring Shortcuts</Text>
