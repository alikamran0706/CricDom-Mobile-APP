...
export default function RegisterUmpireScreen() {
    ...
    const handleCreatePlayer = async () => {
        ...
        try {
            ...
            dispatch(showAlert({ type: 'success', message: id ? 'Umpire updated successfully!' : 'Umpire created successfully!' }));
            router.replace({
                pathname: '/umpires',
                params: { refetch: 'true' }
            });
