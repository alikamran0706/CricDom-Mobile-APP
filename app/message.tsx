                    ...
                    >
                        {messages.length === 0 ? (
                            ...
                            messages.map((msg, index) => (
                                <View
                                    key={index}
                                    className={`mb-2 max-w-[75%] p-3 rounded-xl ${index % 2 === 0
                                            ? "bg-[#0e7ccb] self-end"
                    ...
                    >
                        <View className="px-4 py-3 border-t border-gray-200">
                            ...
                            <View className="flex-row items-center">
                                ...
                                <TouchableOpacity
                                    className={`w-12 h-12 rounded-full items-center justify-center ${message.trim() && (hasReplied || messages.length < 1)
                                            ? "bg-[#0e7ccb]"
                                            : "bg-gray-300"
                                        }`}
                                    onPress={handleSend}
