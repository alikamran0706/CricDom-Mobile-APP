...
const PersonalCoachingScreen = () => {
  ...
  // 🟢 Handle refetch triggered via navigation params
  useEffect(() => {
  ...
  // 🟢 Header component (country selector + tabs)
  ...
  return (
    <SafeAreaView className="bg-white flex-1">
      <View className="flex-1">
        {/* Header */}
        <Header heading={`Personal Coaching (${communityList.length})`} />
