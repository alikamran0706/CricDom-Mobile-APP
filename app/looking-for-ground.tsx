            ...
            <View className="flex-1">
                ...
                <View className="px-4 py-3">
                    <View className="flex-row items-center">
                        ...
                        <Text className="text-xl font-bold text-black ml-3">Looking for a ground to play</Text>
                    </View>
                </View>
                ...
                <ScrollView className="flex-1 px-4 py-6" contentContainerStyle={{ paddingBottom: 100 }}>
                    <TouchableOpacity className="mb-6" onPress={() => setShowEndDatePicker(true)}>
                        <View className="flex-row items-center justify-between">
                            <Text className="text-base font-medium text-gray-600">{startDate ? startDate : `Select booking date and time`}</Text>
